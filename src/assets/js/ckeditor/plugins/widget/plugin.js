...
( function() {
		...
		onLoad: function() {
			CKEDITOR.addCss(
				...
				'.cke_widget_wrapper:hover>.cke_widget_element{' +
					'outline:1px solid 0x111;' +
					'cursor:default' +
				'}' +
				'.cke_widget_wrapper:hover .cke_widget_editable{' +
					'outline:2px solid 0x111' +
				'}' +
	...
	Widget.prototype = {
		...
		initEditable: function( editableName, definition ) {
			// Don't fetchAll just first element which matched selector but look for a correct one. (#13334)
	...
	function createEditableFilter( widgetName, editableName, editableDefinition ) {
        ...
        console.log("createEditableFilter "  + filter.allowedContent + " " + editableDefinition.allowedContent);
